...
impl State {
    ...
    fn victory(&mut self, ctx: &mut BTerm) {
        ...
        ctx.print_color_centered(7, YELLOW, BLACK, "Press 1 to play again.");
...
impl GameState for State {
    fn tick(&mut self, ctx: &mut BTerm) {
        ...
        match current_state {
            TurnState::AwaitingInput => self.input_systems.execute(ecs, res),
            TurnState::PlayerTurn => self.player_systems.execute(ecs, res),
            TurnState::MonsterTurn => self.monster_systems.execute(ecs, res),
